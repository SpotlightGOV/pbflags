...
func setupIntegration(t *testing.T, prefix string, defs []FlagDef) *testEnv {
	t.Helper()
...
// (flag IDs are feature_id/field_number per descriptor.go).
func notificationsDefs(prefix string) []FlagDef {
