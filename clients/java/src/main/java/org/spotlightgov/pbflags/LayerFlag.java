...
/**
 * A typed feature flag that supports layer-scoped evaluation. Evaluation never throws — all
 * exceptions are caught internally, logged, and the compiled default is returned.
 *
